...
public class GameTableServlet extends HttpServlet {
    ...
    private String BuildTableData(Engine game,String username) {
        ...
        for(int i=0;i<game.GetRegisteredNumOfPlayers();i++)
        {
            ...
            users.add(new UserData(game.GetPlayerName(i),game.GetPlayerNumOfWins(i),game.GetPlayerNumOfBuy(i),game.GetPlayerPot(i),getManager().GetUserType(game.GetPlayerName(i)),p_cards ,role,getManager().IsYourTurn(game,game.GetPlayerName(i))));
        }
